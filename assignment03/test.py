...
parser.add_argument('--content-size', type=int, metavar='<int>', default=32, help='Size for resizing content images, 0 for keeping original size, default=32')
parser.add_argument('--style-size', type=int, metavar='<int>', default=32, help='Size for resizing style images, 0 for keeping original size, default=32')
...
parser.add_argument('--ext', type=str, metavar='<ext>', default='.png', help='Extension name of the created images, default=.png')
